...
Additionally, this documentation includes a theoretical overview of the platform's [architecture](./architecture/overview.md), offering insights into its structure and functionality.

Once the platform is released in a beta version, the documentation will be expanded to include instructions for [deploying services on the platform](./development/deployment/overview.md), allowing users to integrate their custom solutions seamlessly into the NaLamKI ecosystem.
