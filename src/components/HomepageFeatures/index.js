...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        The NaLamKI project aims to improve agricultural processes through the use of cloud and AI technologies. To achieve this, a Software-as-a-Service platform is being developed collecting agricultural data. AI applications provided on the platform support farmers in analyzing the condition of plants and soil across large areas, aiding processes such as irrigation, fertilization, and pest control.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        NaLamKI will simplify and speed up crop monitoring on large agricultural areas. Remote data collection combined with AI-driven models, provides valuable insights into farming conditions. Farmers can detect issues with irrigation, fertilization, or pest infestations early, enabling faster responses. This targeted approach reduces the use of pesticides and fertilizers, leading to cost savings, lower environmental impact, and improved climate resilience.
      </>
    ),
  },
];
